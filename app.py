  ...
  # TODO: replace with real venue data from the venues table, using venue_id
        ...
        for detail in venue_details:
            venue_info={
                ...
                'website_link': detail.Venue.website_link if not no_show else detail.website_link,
  ...
  # TODO: replace with real artist data from the artist table, using artist_id
        ...
        for detail in artist_details:
            artist_info={
                ...
                'website_link': detail.Artist.website_link if not no_show else detail.website_link,
